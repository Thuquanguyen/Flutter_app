...
import 'package:app_manage/Controller/swiper_pagination.dart';
            ...
            children: <Widget>[
              Expanded(child: Swiper(
                ...
                itemBuilder: (context, index){
                  return _buildPage(title: titles[index], icon: "images/image_profile.jpg", pageBg: pageBgs[index]);
                },
          ...
          FlatButton(
            ...
            onPressed: (){
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_)=>SignInStateFull())
              );
            },
          ),
          IconButton(
